#!/usr/bin/env node
/**
 * analyze-patterns.mjs — Rejection Pattern Detector for freelance-ops
 *
...
const REPORTS_DIR = join(freelance_ops, 'reports');
...
function analyze() {
  ...
  const enriched = entries.map(e => {
    ...
    const reportPath = reportMatch ? join(freelance_ops, reportMatch[1]) : null;
