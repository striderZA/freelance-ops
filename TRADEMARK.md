# freelance-ops Trademark Policy

This document explains how the "freelance-ops" name and brand may be used.
...
"freelance-ops," its visual identity, or any associated brand assets.
...
- **Describing compatibility, origin, and lineage** — "works with
  freelance-ops," "based on freelance-ops," "fork of freelance-ops," "extends
  freelance-ops" are all welcome and encouraged with attribution.
- **Naming a fork distinctly** — pick your own product name; mention
  freelance-ops as origin if you like.
...
- **Product, service, or company names** that include "freelance-ops" or
  close variants. This includes prefixes, suffixes, and capitalizations:
  "freelance-ops Cloud," "freelance-ops Pro," "freelance-ops SaaS," "freelance-ops
  Hosted," "freelanceops by [vendor]," "Cloud freelance-ops," etc.
- **Endorsement, sponsorship, or affiliation claims** in any context:
  "Powered by freelance-ops," "Official freelance-ops," "Sponsored by
  freelance-ops," "Partner of freelance-ops," "Featured by freelance-ops," and
  similar phrasings.
- **Domain names, social handles, and app store listings** containing
  "freelance-ops" or close variants for commercial purposes.
...
- **Compatibility certifications** that imply official testing or
  approval ("freelance-ops Certified," "freelance-ops Verified").
...
freelance-ops is a community-built project used by tens of thousands of
...
© 2026 Santiago Fernández de Valderrama. "freelance-ops"™ is a trademark of
