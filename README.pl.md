...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="freelance-ops — Wieloagentowy system poszukiwania pracy" width="800"></a>
</p>
...
<p align="center">
  <a href="https://trendshift.io/repositories/25195" target="_blank"><img src="https://trendshift.io/api/badge/repositories/25195" alt="santifer%2Ffreelance-ops | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</p>
...
<p align="center">
  <img src="docs/demo.gif" alt="freelance-ops Demo" width="800">
</p>
...
freelance-ops ([freelance-ops.org](https://freelance-ops.org), znany też jako **freelanceops**) zamienia dowolne AI CLI w pełne centrum dowodzenia poszukiwaniem pracy. Zamiast ręcznego śledzenia aplikacji w arkuszu kalkulacyjnym, dostajesz pipeline zasilany AI, który:
...
> **Ważne: to NIE jest narzędzie do masowego wysyłania aplikacji.** freelance-ops to filtr — pomaga znaleźć te kilka ofert wartych twojego czasu spośród setek. System stanowczo odradza aplikowanie na oferty z oceną poniżej 4.0/5. Twój czas jest cenny, podobnie jak czas rekrutera. Zawsze sprawdzaj przed wysłaniem.

freelance-ops działa agentowo: Claude Code nawiguje po stronach kariery z Playwright, ocenia dopasowanie rozumując nad twoim CV kontra opis stanowiska (nie przez dopasowanie słów kluczowych) i dostosowuje CV do każdego ogłoszenia.
...
Zbudowany przez kogoś, kto użył go do oceny 740+ ofert pracy, wygenerowania 100+ spersonalizowanych CV i zdobycia roli Head of Applied AI. [Przeczytaj pełne case study](https://santifer.io/freelance-ops-system).
...
To sklonuje najnowszą wersję do `./freelance-ops` i zainstaluje zależności. Następnie:
...
**Przy pierwszym uruchomieniu freelance-ops przeprowadza Cię przez konfigurację — CV, profil i docelowe stanowiska — wyłącznie przez rozmowę. Nic nie trzeba edytować ręcznie.**
...
freelance-ops to jedna komenda slash z wieloma trybami:

```text
/freelance-ops                    → Pokaż wszystkie dostępne komendy
/freelance-ops {wklej ofertę}     → Pełny auto-pipeline (ocena + PDF + tracker)
/freelance-ops scan               → Skanuj portale w poszukiwaniu nowych ofert
/freelance-ops pdf                → Generuj CV zoptymalizowane pod ATS
/freelance-ops batch              → Wsadowa ocena wielu ofert
/freelance-ops tracker            → Podgląd statusu aplikacji
/freelance-ops apply              → Wypełnianie formularzy aplikacyjnych z AI
/freelance-ops pipeline           → Przetwarzanie kolejki URL
/freelance-ops contacto           → Wiadomość na LinkedIn
/freelance-ops deep               → Szczegółowe badanie firmy
/freelance-ops training           → Ocena kursu/certyfikatu
/freelance-ops project            → Ocena projektu portfolio
```

Możesz też po prostu wkleić URL oferty lub jej treść — freelance-ops automatycznie to wykryje i uruchomi pełny pipeline.
...
freelance-ops obsługuje główne polskie portale IT. Dwa z nich — JustJoin.it i NoFluffJobs — mają publiczne API i mogą być zintegrowane jako źródła Level 0 (zero tokenów, brak WebSearch, świeże dane w czasie skanowania). Pozostałe portale wymagają weryfikacji ręcznej lub przez Playwright.
...
freelance-ops uwzględnia specyfikę polskiego rynku pracy przy ocenianiu ofert:
...
Jestem Santiago — Head of Applied AI, były founder (zbudowałem i sprzedałem firmę, która nadal działa z moim nazwiskiem). Zbudowałem freelance-ops do zarządzania własnym poszukiwaniem pracy. Zadziałało: użyłem go do zdobycia swojej obecnej roli.
...
**freelance-ops to lokalne narzędzie open source, NIE usługa hostingowa.** Korzystając z tego oprogramowania, potwierdzasz:
...
<a href="https://github.com/santifer/freelance-ops/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=santifer/freelance-ops" alt="Współtwórcy" />
</a>

Znalazłeś pracę dzięki freelance-ops? [Podziel się swoją historią!](https://github.com/santifer/freelance-ops/issues/new?template=i-got-hired.yml)

## Licencja i znak towarowy

Kod jest licencjonowany na [MIT](LICENSE). Nazwa i marka „freelance-ops" są regulowane przez [Politykę Znaków Towarowych](TRADEMARK.md) — dozwolone dla użytku społecznościowego, zastrzeżone dla komercyjnego nazewnictwa produktów i endorsementu.
