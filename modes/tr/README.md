# freelance-ops — Türkçe Modlar (`modes/tr/`)

Bu klasör, Türkiye iş piyasasında iş arayanlar veya Türkçe ilanlarla çalışanlar için freelance-ops modlarının Türkçe çevirilerini içerir.
