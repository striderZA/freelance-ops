...
5. **freelance-ops proof point**: Incluir em "Informações adicionais" se houver campo para isso
...
3. Sugerir próximo passo: `/freelance-ops contacto` para LinkedIn outreach
