# freelance-ops -- AI Job Search Pipeline
...
- `{"status": "update-available", "local": "1.0.0", "remote": "1.1.0", "changelog": "..."}` → tell the user:
  > "freelance-ops update available (v{local} → v{remote}). Your data (CV, profile, tracker, reports) will NOT be touched. Want me to update?"
...
|---------|------------------------|-------------|
| `/freelance-ops` | `/freelance-ops` | Show menu or evaluate JD with args |
| `/freelance-ops-pipeline` | `/freelance-ops pipeline` | Process pending URLs from inbox |
| `/freelance-ops-evaluate` | `/freelance-ops oferta` | Evaluate job offer (A-F scoring) |
| `/freelance-ops-compare` | `/freelance-ops ofertas` | Compare and rank multiple offers |
| `/freelance-ops-contact` | `/freelance-ops contacto` | LinkedIn outreach (find contacts + draft) |
| `/freelance-ops-deep` | `/freelance-ops deep` | Deep company research |
| `/freelance-ops-pdf` | `/freelance-ops pdf` | Generate ATS-optimized CV |
| `/freelance-ops-latex` | `/freelance-ops latex` | Export CV as LaTeX/Overleaf .tex |
| `/freelance-ops-training` | `/freelance-ops training` | Evaluate course/cert against goals |
| `/freelance-ops-project` | `/freelance-ops project` | Evaluate portfolio project idea |
| `/freelance-ops-tracker` | `/freelance-ops tracker` | Application status overview |
| `/freelance-ops-apply` | `/freelance-ops apply` | Live application assistant |
| `/freelance-ops interview` | `/freelance-ops interview` | Interactive profile/CV onboarding interview |
| `/freelance-ops-scan` | `/freelance-ops scan` | Scan portals for new offers |
| `/freelance-ops-batch` | `/freelance-ops batch` | Batch processing with parallel workers |
| `/freelance-ops-patterns` | `/freelance-ops patterns` | Analyze rejection patterns and improve targeting |
...
| `/freelance-ops` | `/freelance-ops` | Show menu or evaluate JD with args |
| `/freelance-ops-pipeline` | `/freelance-ops pipeline` | Process pending URLs from inbox |
| `/freelance-ops-evaluate` | `/freelance-ops oferta` | Evaluate job offer (A-G scoring) |
| `/freelance-ops-compare` | `/freelance-ops ofertas` | Compare and rank multiple offers |
| `/freelance-ops-contact` | `/freelance-ops contacto` | LinkedIn outreach (find contacts + draft) |
| `/freelance-ops-deep` | `/freelance-ops deep` | Deep company research |
| `/freelance-ops-pdf` | `/freelance-ops pdf` | Generate ATS-optimized CV |
...
> - Run `/freelance-ops scan` (or `/freelance-ops-scan` if using OpenCode) to search portals
...
If the user accepts, use the `/loop` or `/schedule` skill (if available) to set up a recurring `/freelance-ops scan` (or `/freelance-ops-scan` if using OpenCode). If those aren't available, suggest adding a cron job or remind them to run `/freelance-ops scan` (or `/freelance-ops-scan` if using OpenCode) periodically.
