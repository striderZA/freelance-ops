# Geteilter Kontext -- freelance-ops (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle freelance-ops-Modi
     in der deutschen Variante. Bevor du freelance-ops verwendest, MUSST du:
