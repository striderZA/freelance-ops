...
/**
 * doctor.mjs — Setup validation for freelance-ops
...
function checkPlaywrightMcp(root) {
  ...
  return {
    ...
    fix: [
      ...
      'may return empty or stale content. Tracking: https://github.com/santifer/freelance-ops/issues/506',
    ],
  };
}
