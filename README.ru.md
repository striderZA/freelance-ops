...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="freelance-ops Мультиагентная система поиска работы" width="800"></a>
</p>
...
<p align="center">
  <img src="docs/demo.gif" alt="freelance-ops Демо" width="800">
</p>
...
freelance-ops превращает любой AI-CLI в полноценный командный центр для поиска работы. Вместо ручного ведения таблиц с откликами вы получаете ИИ-пайплайн, который:
...
Это клонирует последний релиз в `./freelance-ops` и устанавливает зависимости. Затем:
...
**При первом запуске freelance-ops проведёт тебя через настройку — твоё CV, профиль и целевые роли — просто через диалог. Ничего не нужно править вручную.**
...
freelance-ops — одна slash-команда с множеством режимов:

```
/freelance-ops                       → Показать все доступные команды
/freelance-ops {вставь описание JD}  → Полный авто-пайплайн (оценка + PDF + трекер)
/freelance-ops scan                  → Сканирование порталов
/freelance-ops pdf                   → Генерация ATS-резюме
/freelance-ops batch                 → Пакетная оценка вакансий
/freelance-ops tracker               → Статус откликов
/freelance-ops apply                 → Заполнение форм отклика с ИИ
/freelance-ops pipeline              → Обработка очереди URL
/freelance-ops contacto              → Сообщение в LinkedIn
/freelance-ops deep                  → Глубокий анализ компании
/freelance-ops training              → Оценка курса/сертификации
/freelance-ops project               → Оценка портфолио-проекта
```

Или просто вставь URL вакансии — freelance-ops автоматически определит его и запустит полный пайплайн.
...
freelance-ops поддерживает ключевые российские джоб-борды:
...
**freelance-ops — локальный open-source инструмент, НЕ хостинг-сервис.** Используя это ПО, вы подтверждаете:
