# freelance-ops | نظام إدارة وتخطيط البحث عن وظائف باستخدام الذكاء الاصطناعي (وكيل مأتمت)
...
<p align="right" dir="rtl">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="freelance-ops — نظام البحث عن وظائف القائم على عدة وكلاء ذكاء اصطناعي" width="800"></a>
</p>
...
<p align="center">
  ...
  <a href="TRADEMARK.md"><img src="https://img.shields.io/badge/Trademark-Policy-blue.svg" alt="سياسة العلامة التجارية"></a>
  ...
  <img src="https://img.shields.io/badge/AR-green?style=flat" alt="AR">
...
<p align="center">
  <img src="docs/demo.gif" alt="عرض توضيحي لـ freelance-ops" width="800">
</p>
...
يقوم **freelance-ops** ([freelance-ops.org](https://freelance-ops.org)) بتحويل أي واجهة سطر أوامر للبرمجة بالذكاء الاصطناعي (AI coding CLI) إلى مركز قيادة كامل للبحث عن الوظائف. بدلاً من تتبع طلبات التوظيف يدوياً في جداول البيانات، تحصل على مسار عمل مدعوم بالذكاء الاصطناعي يقوم بـ:
...
تم تطوير هذا النظام بواسطة مهندس برمجيات وريادي أعمال استخدمه شخصياً لتقييم أكثر من 740 عرض عمل، وتوليد أكثر من 100 سيرة ذاتية مخصصة، حتى حصل على منصب "رئيس قسم الذكاء الاصطناعي التطبيقي". [اقرأ دراسة الحالة الكاملة](https://santifer.io/freelance-ops-system).
...
يدعم freelance-ops بشكل أصلي واجهة [Gemini CLI](https://github.com/google-gemini/gemini-cli) بنفس الكفاءة والقواعد التي يدعم بها بيئات التوظيف الأخرى. جميع الأوامر الـ 15 متاحة وتستخدم نفس منطق التقييم تحت المجلد `modes/`.
...
```text
/freelance-ops                ← لعرض كافة الأوامر المتاحة وتفاصيلها
/freelance-ops {رابط الوظيفة} ← تشغيل المسار التلقائي بالكامل (تقييم + PDF + تسجيل)
/freelance-ops scan           ← مسح بوابات التوظيف بحثاً عن فرص جديدة
/freelance-ops pdf            ← توليد سيرة ذاتية محسنة ومتوافقة مع ATS
/freelance-ops batch          ← تقييم مجموعة وظائف دفعة واحدة بالتوازي
/freelance-ops tracker        ← عرض وتحديث حالات التقديم الحالية
/freelance-ops apply          ← تعبئة نماذج التوظيف والردود بمساعدة الذكاء الاصطناعي
/freelance-ops pipeline       ← معالجة وفحص روابط الوظائف المنتظرة
/freelance-ops contacto       ← صياغة رسائل التواصل الموجهة عبر LinkedIn
/freelance-ops deep           ← إجراء بحث معمق واستخباراتي حول الشركة المستهدفة
/freelance-ops training       ← تقييم دورة تدريبية أو شهادة مهنية ومدى فائدتها لك
/freelance-ops project        ← تقييم مشروع شخصي في معرض أعمالك وكيفية عرضه
```
...
**freelance-ops هي أداة محلية مفتوحة المصدر بالكامل — وليست خدمة مستضافة.** عند استخدامك لهذا البرنامج، فإنك تقر وتوافق على التالي:
...
<a href="https://github.com/santifer/freelance-ops/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=santifer/freelance-ops" alt="Contributors" />
</a>

هل نجحت في الحصول على وظيفة أحلامك باستخدام هذا النظام؟ [شارك قصتك معنا لتلهم الآخرين!](https://github.com/santifer/freelance-ops/issues/new?template=i-got-hired.yml)
