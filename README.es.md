...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="freelance-ops Sistema Multi-Agente de Busqueda de Empleo" width="800"></a>
</p>
...
<p align="center">
  <a href="https://warpchart.dev/hq">
    <picture>
      ...
      <img alt="Live star telemetry of santifer/freelance-ops" src="https://warpchart.dev/api/chart?theme=light&v=3" loading="lazy">
    </picture>
  </a>
</p>
...
freelance-ops convierte cualquier CLI de IA en un centro de mando de busqueda de empleo. En vez de trackear aplicaciones en un spreadsheet, tienes un pipeline AI que:
...
> **Importante: Esto NO es para spamear empresas.** freelance-ops es un filtro -- te ayuda a encontrar las pocas ofertas que merecen tu tiempo entre cientos. El sistema recomienda encarecidamente no aplicar a nada por debajo de 4.0/5. Tu tiempo es valioso, y el del recruiter tambien. Siempre revisa antes de enviar.
...
Construido por alguien que lo uso para evaluar 740+ ofertas, generar 100+ CVs personalizados, y conseguir un rol de Head of Applied AI. [Lee el case study completo](https://santifer.io/freelance-ops).
...
Esto clona la ultima release en `./freelance-ops` e instala las dependencias. Despues:
...
**En el primer arranque, freelance-ops te guia en la configuracion — tu CV, tu perfil y los roles que buscas — simplemente conversando. No hay nada que editar a mano.**
...
freelance-ops es un unico slash command con multiples modos:

```
/freelance-ops                → Mostrar todos los comandos
/freelance-ops {pega un JD}   → Pipeline completo (evaluar + PDF + tracker)
/freelance-ops scan           → Escanear portales
/freelance-ops pdf            → Generar CV ATS-optimizado
/freelance-ops batch          → Evaluar ofertas en batch
/freelance-ops tracker        → Ver estado de aplicaciones
/freelance-ops apply          → Rellenar formularios con IA
/freelance-ops pipeline       → Procesar URLs pendientes
/freelance-ops contacto       → Mensaje LinkedIn outreach
/freelance-ops deep           → Research profundo de empresa
```

O simplemente pega una URL o descripcion de oferta -- freelance-ops la detecta y ejecuta el pipeline completo.
...
Soy Santiago -- Head of Applied AI, ex-fundador (monte y vendi un negocio que sigue funcionando con mi nombre). Construi freelance-ops para gestionar mi propia busqueda de empleo. Funciono: lo use para conseguir mi puesto actual.
...
**freelance-ops es una herramienta local y open source — NO un servicio alojado.** Al usar este software, aceptas que:
