...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="freelance-ops Multi-Agent Job Search System" width="800"></a>
</p>
...
&nbsp;
<a href="https://www.npmjs.com/package/@santifer/freelance-ops"><img src="https://img.shields.io/npm/dt/@santifer/freelance-ops?style=for-the-badge&logo=npm&color=CB3837&label=npx%20installs" alt="npm installs"></a></p>
...
freelance-ops transforma qualquer CLI de código com IA em uma central completa de busca de emprego. Em vez de acompanhar candidaturas manualmente em planilha, você tem um pipeline com IA que:
...
> **Importante: isso NÃO é uma ferramenta de disparo em massa.** freelance-ops é um filtro -- ajuda você a encontrar as poucas vagas que realmente valem seu tempo entre centenas. O sistema recomenda fortemente não se candidatar a nada com nota abaixo de 4.0/5. Seu tempo é valioso, e o do recrutador também. Sempre revise antes de enviar.

freelance-ops é agentic: Claude Code navega páginas de carreira com Playwright, avalia aderência comparando seu CV com a descrição da vaga (não por simples correspondência de palavras-chave) e adapta seu currículo para cada vaga.
...
Construído por alguém que usou isso para avaliar 740+ vagas, gerar 100+ CVs personalizados e conquistar uma posição de Head of Applied AI. [Leia o estudo de caso completo](https://santifer.io/freelance-ops-system).
...
Isso clona o último release em `./freelance-ops` e instala as dependências. Depois:
...
**No primeiro uso, o freelance-ops conduz você pela configuração — seu CV, perfil e vagas-alvo — apenas conversando. Nada para editar à mão.**
...
freelance-ops é um único comando slash com múltiplos modos:

```
/freelance-ops                → Mostrar todos os comandos disponíveis
/freelance-ops {cole um JD}   → Auto-pipeline completo (avaliar + PDF + tracker)
/freelance-ops scan           → Escanear portais por novas vagas
/freelance-ops pdf            → Gerar CV otimizado para ATS
/freelance-ops batch          → Avaliar múltiplas vagas em lote
/freelance-ops tracker        → Ver status das candidaturas
/freelance-ops apply          → Preencher formulários de candidatura com IA
/freelance-ops pipeline       → Processar URLs pendentes
/freelance-ops contacto       → Mensagem de outreach no LinkedIn
/freelance-ops deep           → Pesquisa aprofundada da empresa
/freelance-ops training       → Avaliar um curso/certificação
/freelance-ops project        → Avaliar um projeto de portfólio
```

Ou apenas cole uma URL ou descrição de vaga diretamente -- freelance-ops detecta automaticamente e roda o pipeline completo.
...
Sou o Santiago -- Head of Applied AI, ex-fundador (criei e vendi uma empresa que ainda opera com meu nome). Eu construí o freelance-ops para gerenciar minha própria busca de emprego. Funcionou: usei o sistema para conquistar meu cargo atual.
...
**freelance-ops é uma ferramenta local e open source — NÃO é um serviço hospedado.** Ao usar este software, você reconhece que:
